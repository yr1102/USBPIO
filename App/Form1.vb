...
#Region " Windows ƒtƒH[ƒ€ ƒfƒUƒCƒi‚Å¶¬‚³‚ê‚½ƒR[ƒh "
    ...
    Public Sub New()
        ...
        ' InitializeComponent() ŒÄ‚Ño‚µ‚ÌŒã‚É‰Šú‰»‚ğ’Ç‰Á‚µ‚Ü‚·B

    End Sub

    ' Form ‚Í dispose ‚ğƒI[ƒo[ƒ‰ƒCƒh‚µ‚ÄƒRƒ“ƒ|[ƒlƒ“ƒgˆê——‚ğÁ‹‚µ‚Ü‚·B
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label36.Text = "ƒRƒƒ“ƒg" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "‹L“ü‚É‚Ä" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "•œ‹Aó•t"
        '
        'TextBox30
        '
        ...
        Me.Label38.Text = "Œ´ˆö" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "‘Îô"
        '
        'TextBox31
        '
        ...
        Me.Label26.Text = "Œx" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "•\¦"
        '
        'TextBox14
        '
        ...
        Me.Label23.Text = "Œx" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "İ’è"
        '
        'TextBox12
        '
        ...
        Me.Label15.Text = "¶Y" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "î•ñ"
        '
        'TextBox9
        '
        ...
        Me.Label1.Font = New System.Drawing.Font("HGPºŞ¼¯¸M", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
        ...
        Me.Label1.Text = "’ÊM" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "ƒGƒ‰["
        '
        'Button1
        '
...
#End Region
    ...
    '    '***ƒtƒH[ƒ€‚Ì•\¦ŠJn‚Ì‰Šú‰»ˆ—***
    '    Function_Disable() '***
    '    IDNUM.SelectedIndex = 0 '***‰Šú‘I‘ğID‚ğ0‚É‚·‚é
    'End Sub
    'Private Sub Function_Disable()
    '    '***ƒI[ƒvƒ“‚ÆID‘I‘ğƒ{ƒ^ƒ“ˆÈŠO‚ÌŠeƒ{ƒ^ƒ“‹@”\‚ğ–³Œø‚É‚·‚é***
    '    DevClose.Enabled = False '***ƒNƒ[ƒYƒ{ƒ^ƒ“–³Œø
    '    DevOpen.Enabled = True '***ƒI[ƒvƒ“ƒ{ƒ^ƒ“—LŒø
    '    IDNUM.Enabled = True '***ID‘I‘ğƒ{ƒ^ƒ“—LŒø
    '    '***ˆÈ‰º‚Ìƒ{ƒ^ƒ“‚·‚×‚Ä–³Œø
    'End Sub

    'Private Sub Function_Enable()
    '    '***ƒI[ƒvƒ“‚ÆID‘I‘ğƒ{ƒ^ƒ“‚Ì‚İ‚ğ–³Œø‚É‚·‚éB***
    '    DevOpen.Enabled = False '***ƒI[ƒvƒ“ƒ{ƒ^ƒ“–³Œø
    '    DevClose.Enabled = True '***ƒNƒ[ƒYƒ{ƒ^ƒ“—LŒø
    '    IDNUM.Enabled = False '***ID‘I‘ğƒ{ƒ^ƒ“–³Œø
    '    '***ˆÈ‰º‚Ìƒ{ƒ^ƒ“‚·‚×‚Ä—LŒø
    'End Sub
    ...
    '        Function_Enable() '***Še‹@”\ƒ{ƒ^ƒ“‚ğ—LŒø‚É‚·‚é
    '    Else
    '        MsgBox("ƒI[ƒvƒ“‚Å‚«‚Ü‚¹‚ñ‚Å‚µ‚½") '***ƒI[ƒvƒ“‚É¸”s‚µ‚½ê‡
    '    End If
    'End Sub

    'Private Sub DevClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    '***ƒfƒoƒCƒX‚ÌƒNƒ[ƒY***
    '    sacomUsbIoClose(IDNUM.SelectedIndex) '***ƒfƒoƒCƒXƒNƒ[ƒY
    '    Function_Disable() '***ƒ{ƒ^ƒ“‚Ì—LŒø–³ŒøØ‚è‘Ö‚¦12
    'End Sub

    'Private Sub LowDir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    '***‰ºˆÊƒoƒCƒg‚Ì“üo—Í•ûŒüİ’è
    '    Dim Ret As String
    '    Dim Dir As Byte
    '    Ret = InputBox("‰ºˆÊƒoƒCƒg‚Ì“üo—Í’è‹`’l‚ğ“ü—Í‚µ‚Ä‚­‚¾‚³‚¢(HEX)", "Pio_LowDirection", "0")
    '    If Ret.Length > 0 Then '***OK‚Å•Ô‚Á‚Ä‚«‚Ä‚¢‚é‚©
    '        If IsNumeric("&h" & Ret) Then
    '            Dir = CByte("&h" & Ret)
    '            If (Dir >= 0 And Dir <= &HFFS) Then '*** ƒf[ƒ^‚Ì”ÍˆÍ‚É‚ ‚é‚©
    '                If sacomUsbIoDirL(IDNUM.SelectedIndex, Dir) <> True Then '***DLLŠÖ”‚ÌÀs
    '                    MsgBox("DLLŠÖ”‚ÌÀs‚É¸”s‚µ‚Ü‚µ‚½BƒfƒoƒCƒX‚ğƒNƒ[ƒY‚µ‚Ü‚·B") '***‘‚«‚±‚İ‚É¸”s
    '                    DevClose_Click(DevClose, New System.EventArgs())
    '                End If
    '            Else
    '                MsgBox("ƒf[ƒ^‚Ì”ÍˆÍ‚Í0`FF(HEX)‚Å‚·B")
    '            End If
    '        Else
    '            MsgBox("ƒf[ƒ^‚Ì“ü—ÍŒ`®‚ªŠÔˆá‚Á‚Ä‚¢‚Ü‚·->[" & Ret & "]")
    '        End If
    '    End If
    'End Sub

    'Private Sub HighDir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    '***ãˆÊƒoƒCƒg‚Ì“üo—Í•ûŒüİ’è
    '    Dim Ret As String
    '    Dim Dir As Byte
    '    Ret = InputBox("ãˆÊƒoƒCƒg‚Ì“üo—Í’è‹`’l‚ğ“ü—Í‚µ‚Ä‚­‚¾‚³‚¢(HEX)", "Pio_HighDirection", "0")
    '    If Ret.Length > 0 Then '***OK‚Å•Ô‚Á‚Ä‚«‚Ä‚¢‚é‚©
    '        If IsNumeric("&h" & Ret) Then
    '            Dir = CByte("&h" & Ret)
    '            If (Dir >= 0 And Dir <= &HFFS) Then '*** ƒf[ƒ^‚Ì”ÍˆÍ‚É‚ ‚é‚©
    '                If sacomUsbIoDirH(IDNUM.SelectedIndex, Dir) <> True Then '***DLLŠÖ”‚ÌÀs
    '                    MsgBox("DLLŠÖ”‚ÌÀs‚É¸”s‚µ‚Ü‚µ‚½BƒfƒoƒCƒX‚ğƒNƒ[ƒY‚µ‚Ü‚·B") '***‘‚«‚±‚İ‚É¸”s
    '                    DevClose_Click(DevClose, New System.EventArgs())
    '                End If
    '            Else
    ...
    '    Dim Ret As String
    '    Dim Dir As Byte
    '    Ret = InputBox("‰ºˆÊƒoƒCƒg‚Ìo—Í’l‚ğ“ü—Í‚µ‚Ä‚­‚¾‚³‚¢(HEX)", "Pio_LowByteWrite", "0")
    '    If Ret.Length > 0 Then '***OK‚Å•Ô‚Á‚Ä‚«‚Ä‚¢‚é‚©
    '        If IsNumeric("&h" & Ret) Then
    '            Dir = CByte("&h" & Ret)
    '            If (Dir >= 0 And Dir <= &HFFS) Then '*** ƒf[ƒ^‚Ì”ÍˆÍ‚É‚ ‚é‚©
    '                If sacomUsbIoWriteL(IDNUM.SelectedIndex, Dir) <> True Then '***DLLŠÖ”‚ÌÀs
    '                    MsgBox("DLLŠÖ”‚ÌÀs‚É¸”s‚µ‚Ü‚µ‚½BƒfƒoƒCƒX‚ğƒNƒ[ƒY‚µ‚Ü‚·B") '***‘‚«‚±‚İ‚É¸”s
    '                    DevClose_Click(DevClose, New System.EventArgs())
    '                End If
    '            Else
    ...
    '    Dim Ret As String
    '    Dim Dir As Byte
    '    Ret = InputBox("ãˆÊƒoƒCƒg‚Ìo—Í’l‚ğ“ü—Í‚µ‚Ä‚­‚¾‚³‚¢(HEX)", "Pio_HighByteWrite", "0")
    '    If Ret.Length > 0 Then '***OK‚Å•Ô‚Á‚Ä‚«‚Ä‚¢‚é‚©
    '        If IsNumeric("&h" & Ret) Then
    '            Dir = CByte("&h" & Ret)
    '            If (Dir >= 0 And Dir <= &HFFS) Then '*** ƒf[ƒ^‚Ì”ÍˆÍ‚É‚ ‚é‚©
    '                If sacomUsbIoWriteH(IDNUM.SelectedIndex, Dir) <> True Then '***DLLŠÖ”‚ÌÀs
    '                    MsgBox("DLLŠÖ”‚ÌÀs‚É¸”s‚µ‚Ü‚µ‚½BƒfƒoƒCƒX‚ğƒNƒ[ƒY‚µ‚Ü‚·B") '***‘‚«‚±‚İ‚É¸”s
    '                    DevClose_Click(DevClose, New System.EventArgs())
    '                End If
    '            Else
    ...
    '    '***‰ºˆÊƒoƒCƒg‚Ì“ü—Íƒf[ƒ^‚Ìæ“¾
    '    Dim dat As Byte
    '    If sacomUsbIoReadL(IDNUM.SelectedIndex, dat) <> True Then '***DLLŠÖ”‚ÌÀs
    '        MsgBox("DLLŠÖ”‚ÌÀs‚É¸”s‚µ‚Ü‚µ‚½BƒfƒoƒCƒX‚ğƒNƒ[ƒY‚µ‚Ü‚·B") '***‘‚«‚±‚İ¸”s
    '        DevClose_Click(DevClose, New System.EventArgs())
    '    Else
    '        MsgBox("‰ºˆÊƒoƒCƒg“ü—Í’l‚Í " & Hex(dat) & "(HEX) ‚Å‚·")
    '    End If
    'End Sub

    'Private Sub HighRead_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    '***ãˆÊƒoƒCƒg‚Ì“ü—Íƒf[ƒ^‚Ìæ“¾
    '    Dim dat As Byte
    '    If sacomUsbIoReadH(IDNUM.SelectedIndex, dat) <> True Then '***DLLŠÖ”‚ÌÀs
    '        MsgBox("DLLŠÖ”‚ÌÀs‚É¸”s‚µ‚Ü‚µ‚½BƒfƒoƒCƒX‚ğƒNƒ[ƒY‚µ‚Ü‚·B") '***‘‚«‚±‚İ¸”s
    '        DevClose_Click(DevClose, New System.EventArgs())
    '    Else
    '        MsgBox("ãˆÊƒoƒCƒg“ü—Í’l‚Í " & Hex(dat) & "(HEX) ‚Å‚·")
    '    End If
    'End Sub
    ...
    '    Dim Ret As String
    '    Dim Dir As Integer
    '    Ret = InputBox("o—Í’l‚ğ“ü—Í‚µ‚Ä‚­‚¾‚³‚¢(HEX)", "Pio_WordWrite", "0")
    '    If Ret.Length > 0 Then '***OK‚Å•Ô‚Á‚Ä‚«‚Ä‚¢‚é‚©
    '        If IsNumeric("&h" & Ret) Then
    '            Dir = CInt("&h" & Ret)
    '            If (Dir >= 0 And Dir <= &HFFFF) Then '*** ƒf[ƒ^‚Ì”ÍˆÍ‚É‚ ‚é‚©
    '                If sacomUsbIoWrite(IDNUM.SelectedIndex, Dir) <> True Then '***DLLŠÖ”‚ÌÀs
    '                    MsgBox("DLLŠÖ”‚ÌÀs‚É¸”s‚µ‚Ü‚µ‚½BƒfƒoƒCƒX‚ğƒNƒ[ƒY‚µ‚Ü‚·B") '***‘‚«‚±‚İ‚É¸”s
    '                    DevClose_Click(DevClose, New System.EventArgs())
    '                End If
    '            Else
    '                MsgBox("ƒf[ƒ^‚Ì”ÍˆÍ‚Í0`FFFF(HEX)‚Å‚·B")
    '            End If
    '        Else
    '            MsgBox("ƒf[ƒ^‚Ì“ü—ÍŒ`®‚ªŠÔˆá‚Á‚Ä‚¢‚Ü‚·->[" & Ret & "]")
    '        End If
    ...
    Public cntslot As Integer      '“Š“ü‚ğslot‚Æ•\Œ»@“Š“ü‚ÌƒJƒEƒ“ƒg
    Private numtable As Integer = 0  '1ƒe[ƒuƒ‹‚ ‚½‚è‚Ì“Š“ü”
    Private cnttable As Integer = 0   'ƒe[ƒuƒ‹‚É‚¢‚­‚Â‚ ‚é‚©‚ğ‹L‰¯‚·‚é•Ï”
    'Public Table(38) As Short      'Šeƒe[ƒuƒ‹—p‚Ì”z—ñ@ŒŸ¸€–Ú‚Í38”Ô–Ú(‰ñ˜H’ïR‚Ì‘O)‚Ü‚Å‚í‚©‚ê‚Î‚¢‚¢‚Ì‚Å‘Sƒe[ƒuƒ‹•ª(54ŒÂ)Šm•Û‚µ‚È‚¢
    Private i As Short              'ƒe[ƒuƒ‹”z—ñ—pfor•¶‚ÌƒJƒEƒ“ƒgƒAƒbƒv
    ...
    Public cntdef1 As Integer     '•s—ÇƒJƒEƒ“ƒg“®ì’á
    Public cntdef2 As Integer     '•s—ÇƒJƒEƒ“ƒg“®ì‚
    Public cntdef3 As Integer     '•s—ÇƒJƒEƒ“ƒg•œ‹A’á
    Public cntdef4 As Integer@@ '•s—ÇƒJƒEƒ“ƒg•œ‹A‚
    Public cntdef5 As Integer     '•s—ÇƒJƒEƒ“ƒg‘Ïˆ³â‰
    Public cntdef6 As Integer     '•s—ÇƒJƒEƒ“ƒg‰ñ˜H’ïR

    Public cntgood1 As Integer     '—Ç•iƒJƒEƒ“ƒg“®ì’á
    Public cntgood2 As Integer     '—Ç•iƒJƒEƒ“ƒg“®ì‚
    Public cntgood3 As Integer     '—Ç•iƒJƒEƒ“ƒg•œ‹A’á
    Public cntgood4 As Integer@@ '—Ç•iƒJƒEƒ“ƒg•œ‹A‚
    Public cntgood5 As Integer     '—Ç•iƒJƒEƒ“ƒg‘Ïˆ³â‰
    Public cntgood6 As Integer     '—Ç•iƒJƒEƒ“ƒg‰ñ˜H’ïR


    Private logdef1 As Integer     '‹æ•ª“à•s—ÇƒJƒEƒ“ƒg“®ì’á
    Private logdef2 As Integer     '‹æ•ª“à•s—ÇƒJƒEƒ“ƒg“®ì‚
    Private logdef3 As Integer     '‹æ•ª“à•s—ÇƒJƒEƒ“ƒg•œ‹A’á
    Private logdef4 As Integer@@ '‹æ•ª“à•s—ÇƒJƒEƒ“ƒg•œ‹A‚
    Private logdef5 As Integer     '‹æ•ª“à•s—ÇƒJƒEƒ“ƒg‘Ïˆ³â‰
    Private logdef6 As Integer     '‹æ•ª“à•s—ÇƒJƒEƒ“ƒg‰ñ˜H’ïR

    Private logslot1 As Integer     '‹æ•ªƒJƒEƒ“ƒg“®ì’á
    Private logslot2 As Integer     '‹æ•ªƒJƒEƒ“ƒg“®ì‚
    Private logslot3 As Integer     '‹æ•ªƒJƒEƒ“ƒg•œ‹A’á
    Private logslot4 As Integer@@ '‹æ•ªƒJƒEƒ“ƒg•œ‹A‚
    ...
    Private Sub Form1_Load2(sender As System.Object, e As System.EventArgs) Handles MyBase.Shown, MyBase.Load
        ...
        'Timer1‚Ìİ’è
        Label2.Text = "•\¦‚µ‚Ü‚·B"
        Timer1.Interval = 100 '0.1•b‚ÌƒCƒ“ƒ^[ƒoƒ‹‚Åî•ñ‚ğXV
    ...
    Private Sub Timer1_Tick(sender As System.Object, ev As System.EventArgs) Handles Timer1.Tick
        ...
        sacomUsbIoRead(pio_id, dat)             'PIO‚ğŒÄ‚Ño‚µ‚ÄŒ»İ‚Ìî•ñ‚ğ“üè
        Label2.Text = Hex(dat)                  'ƒ‰ƒxƒ‹2‚ÉŒ»İ‚Ì“ü—Íî•ñ‚ğ16i”‚Å•\¦
        dathex = Hex(dat)

        Slot1.Text = cntslot             'ƒ‰ƒxƒ‹1‚ÉŒ»İ‚Ì“Š“ü”‚ğ•\¦
        ...
        '`````ˆÈ‰ºƒGƒ‰[‚Ì“_“”ˆ—@¡‰ñ‚Ì‰ñ˜H‚ÍƒfƒtƒHƒ‹ƒg‚ªF‚Ì‚½‚ß“_“”‚·‚ê‚Î‚·‚é‚Ù‚Ç”‚ª¬‚³‚­‚È‚é``
        ...
        If dathex.StartsWith("5") Then                                      'dathex‚É“ü‚Á‚Ä‚¢‚éî•ñ‚ğƒ`ƒFƒbƒN@startswith‚Í16bitî•ñ‚ÌÅ‰‚Ì4bit‚Ì‚İ‚ğQÆ‚·‚é‹@”\‚Å‚ ‚é
            ...
            If dathex.EndsWith("8") Then                                    'dathex‚É“ü‚Á‚Ä‚¢‚éî•ñ‚ğƒ`ƒFƒbƒN@endwith‚Í16bitî•ñ‚ÌÅŒã‚Ì4bit‚Ì‚İ‚ğQÆ‚·‚é‹@”\‚Å‚ ‚é
                PictureBox1.BackColor = Color.LightGreen                    'ÅŒã‚Ì4bit‚É‚Íƒpƒgƒ‰ƒCƒg‚Ìó‘Ô‚ª‘‚«‚Ü‚ê‚Ä‚¢‚é‚Ì‚Å‚»‚Ì”’l‚ğ”»’f‚µ‚»‚ê‚É‘Î‰‚µ‚½ƒpƒgƒ‰ƒCƒgF‚ğ“_“”‚³‚¹‚ê‚Î—Ç‚¢
                PictureBox2.BackColor = Color.Yellow
                PictureBox3.BackColor = Color.Red                           '‘—‚ç‚ê‚Ä‚­‚é”’l‚ª8‚È‚ç‚Î‘S“_“”‚Ì‚Í‚¸‚È‚Ì‚Å‰¼‘zƒpƒgƒ‰ƒCƒgPictureBox1,2,3‚ğdarkF¨–¾‚é‚¢F‚É•Ï‚¦‚Ä‚¢‚é
            ...
            ElseIf dathex.EndsWith("9") Then                                '’l‚ª9‚Å‚ ‚Á‚½ê‡‚Ìˆ—A‚±‚Ìê‡‚Í‰©F‚ÆÔF‚Ì“_“”‚É‚È‚éB
                ...
                If flag_light <> "9" Then                                   '“_“”“_–Åƒ`ƒFƒbƒNˆ—‚ğ‚¢‚ê‚é@“_“”ó‘Ô(flag_light)‚Ìî•ñ‚ğ‚à‚Æ‚É
                    If flag_light = "B" Then                                '‰©F“_“”‰ñ”oc(ou)ntyellowp@ÔF“_“”‰ñ”oc(ou)ntredp‚É“_“”‰ñ”‚ğ1‘‚â‚·‚Æ‚¢‚¤‚±‚Æ‚ğs‚Á‚Ä‚¢‚é
                        cntyellow += 1
                        flag_light = "9"
                    ElseIf flag_light = "A" Then                            '‚½‚Æ‚¦‚Î‰©F‚ª“_“”‚µ‚½‚Æ‚«‚É‰©F“_“”‚ª{1‚³‚ê‚éˆ—‚É‚µ‚Ä‚µ‚Ü‚¤‚ÆA‰©{Ô“_“”¨‰©‚Ì‚İ“_“”‚Æ•Ï‰»‚µ‚½‚Æ‚«‚É‚à
                        cntyellow += 1                                      '‰©F‚ğ2‰ñ“_“”‚ÆƒJƒEƒ“ƒg‚µ‚Ä‚µ‚Ü‚¤(Œ©‚Ä‚¢‚é‘¤‚©‚ç‚·‚é‚ÆŒõ‚è‚Á‚Ï‚È‚µ)
                        flag_light = "9"                                    '‚»‚ê‚ğ‰ñ”ğ‚·‚é‚½‚ß‚ÉA“_“”ó‘Ô(flag_light)‚Éî•ñ‚ğ’~‚¦’¼‘O‚É‰½F‚ªŒõ‚Á‚Ä‚¢‚½‚©‚Ìî•ñ‚ğ
                    ElseIf flag_light <> "9" Then                           'ˆø‚«Œp‚®‚æ‚¤‚É‚µ‚Ä‚¢‚é
                        cntred += 1
                    End If
        ...
        If dathex.StartsWith("6") Or dathex.StartsWith("7") Then           'dathex‚É“ü‚Á‚Ä‚¢‚éî•ñ‚ğƒ`ƒFƒbƒN@startswith‚Í16bitî•ñ‚ÌÅ‰‚Ì4bit‚Ì‚İ‚ğQÆ‚·‚é‹@”\‚Å‚ ‚é
            ...
            If flag_ch <> "CH4" Then
                ...
                'Slot2.Text = cntgood1 + cntdef1    'ŒŸ¸”‚Ì”½‰f(“®ì’á)       
                'Slot3.Text = cntgood2 + cntdef2    'ŒŸ¸”‚Ì”½‰f(“®ì‚)@ŒŸ¸”‚Í‘OŒŸ¸H’ö‚Å‚Ì•s—Ç‚Ì”Œ¸‚é‚Ì‚Å“¯‚¶‚Æ‚ÍŒÀ‚ç‚È‚¢
                'Slot4.Text = cntgood3 + cntdef3    'ŒŸ¸”‚Ì”½‰f(•œ‹A‚)
                'Slot5.Text = cntgood4 + cntdef4    'ŒŸ¸”‚Ì”½‰f(•œ‹A’á)
                'Slot6.Text = cntgood5 + cntdef5    'ŒŸ¸”‚Ì”½‰f(‘Ïˆ³â‰)
                'Slot7.Text = cntgood6 + cntdef6    'ŒŸ¸”‚Ì”½‰f(‰ñ˜H’ïR)
    ...
    Private Sub Def_count(datdef As String, ch As String)       'Def_count(ƒf[ƒ^,CH–¼)‚Åó‚¯‚Á‚½ƒf[ƒ^‚ğ‚à‚Æ‚Éˆ—‚ğs‚¤
        ...
        If flag_ch <> ch Then                                   '‘—‚ç‚ê‚Ä‚­‚é16i”‚Ì2•¶š–Ú‚É‚Í‰ñ˜H’ïR‚Æâ‰‘Ïˆ³‚Ì•s—Ç‚ÌM†‚ª“ü‚Á‚Ä‚¢‚é
            ...
            '‚±‚Ì16i”‚ªD‚Ìê‡‚Í‰ñ˜H‚ªƒGƒ‰[AE‚Ìê‡‚Íâ‰...‚Æ‚¢‚Á‚½‚æ‚¤‚É
    ...
    Private Sub Slot_LabelChanged(sender As Object, ev As EventArgs) Handles Slot1.TextChanged '•ÏX‚ª‰Á‚í‚Á‚½ê‡
        ...
        Slot2.Text = cntdef1 + cntgood1    'ŒŸ¸”‚Ì”½‰f(“®ì’á)       
        Slot3.Text = cntdef2 + cntgood2    'ŒŸ¸”‚Ì”½‰f(“®ì‚)@ŒŸ¸”‚Í‘OŒŸ¸H’ö‚Å‚Ì•s—Ç‚Ì”Œ¸‚é‚Ì‚Å“¯‚¶‚Æ‚ÍŒÀ‚ç‚È‚¢
        Slot4.Text = cntdef3 + cntgood3    'ŒŸ¸”‚Ì”½‰f(•œ‹A‚)
        Slot5.Text = cntdef4 + cntgood4    'ŒŸ¸”‚Ì”½‰f(•œ‹A’á)
        Slot6.Text = cntdef5 + cntgood5    'ŒŸ¸”‚Ì”½‰f(‘Ïˆ³â‰)
        Slot7.Text = cntdef6 + cntgood6    'ŒŸ¸”‚Ì”½‰f(‰ñ˜H’ïR)



        Good1.Text = cntgood1    '—Ç•i”‚Ì”½‰f(“®ì’á)
        Good2.Text = cntgood2    '—Ç•i”‚Ì”½‰f(“®ì‚)
        Good3.Text = cntgood3  @'—Ç•i”‚Ì”½‰f(•œ‹A‚)
        Good4.Text = cntgood4    '—Ç•i”‚Ì”½‰f(•œ‹A’á)
        Good5.Text = cntgood5    '—Ç•i”‚Ì”½‰f(‘Ïˆ³â‰)
        Good6.Text = cntgood6    '—Ç•i”‚Ì”½‰f(‰ñ˜H’ïR)

        DefLbl1.Text = cntdef1   '•s—Ç”‚Ì”½‰f(“®ì’á)
        DefLbl2.Text = cntdef2   '•s—Ç”‚Ì”½‰f(“®ì‚)
        DefLbl3.Text = cntdef3   '•s—Ç”‚Ì”½‰f(•œ‹A‚)
        DefLbl4.Text = cntdef4   '•s—Ç”‚Ì”½‰f(•œ‹A’á)
        DefLbl5.Text = cntdef5   '•s—Ç”‚Ì”½‰f(‘Ïˆ³â‰)
        DefLbl6.Text = cntdef6   '•s—Ç”‚Ì”½‰f(‰ñ˜H’ïR)


        'Good1.Text = a - cntdef1     '—Ç•i”‚Ì”½‰f(“®ì’á)
        'Good2.Text = b - cntdef2     '—Ç•i”‚Ì”½‰f(“®ì‚)
        'Good3.Text = c - cntdef3   @'—Ç•i”‚Ì”½‰f(•œ‹A‚)
        'Good4.Text = d - cntdef4     '—Ç•i”‚Ì”½‰f(•œ‹A’á)
        'Good5.Text = e - cntdef5     '—Ç•i”‚Ì”½‰f(‘Ïˆ³â‰)
        'Good6.Text = f - cntdef6     '—Ç•i”‚Ì”½‰f(‰ñ˜H’ïR)
    ...
    Private Sub Slot_LabelChanged2(sender As Object, e As EventArgs) Handles Slot1.TextChanged '“Š“ü”‚É•ÏX‚ª‰Á‚í‚Á‚½ê‡
