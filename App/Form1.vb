...
#End Region
    ...
    Private Sub Slot_LabelChanged(sender As Object, ev As EventArgs) Handles Timer1.Tick '0.1秒に一回更新
    ...
    Private Sub Slot_LabelChanged2(sender As Object, e As EventArgs) Handles Timer1.Tick '投入数に変更が加わった場合
