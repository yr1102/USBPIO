...
#End Region
    ...
    Private Sub Timer1_Tick(sender As System.Object, e As System.EventArgs) Handles Timer1.Tick
        ...
        '～～～～～～～～～～～～～～～～～～～カウント処理～～～～～～～～～～～～～～～～～～～～～～～～
        If dathex.StartsWith("6") Then                                    'dathexに入っている情報をチェック　startswithは16bit情報の最初の4bitのみを参照する機能である
    ...
    Private Sub Slot_LabelChanged(sender As Object, e As EventArgs) Handles Slot1.TextChanged '変更が加わった場合
        ...
        Slot3.Text = Slot1.Text '-不良1
        Slot4.Text = Slot3.Text '-不良2
        Slot5.Text = Slot4.Text '-不良3
        Slot6.Text = Slot5.Text '-不良4
        Slot7.Text = Slot6.Text '-不良5
